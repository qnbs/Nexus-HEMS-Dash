...
**Remaining intentional backlog:** adapter worker activation (MED-12), multi-user RBAC (ADR-009), Storybook coverage (LOW-08), optional `style-src-attr` tightening (AUD-02 follow-up).
