...
| Coverage gates | ⚠️ | Enforced thresholds: API 55/45/55/55, web 65/60/53/65 (`vitest.config.ts`). `pnpm test:coverage` passes. Staged roadmap target 70%+ (see `docs/Testing-Coverage-Strategy.md`, MED-01). |
