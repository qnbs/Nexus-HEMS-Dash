...
| Coverage gates | ⚠️ | Enforced thresholds: API 55/45/55/55, web 70/63/56/70 (`vitest.config.ts`). `pnpm test:coverage` passes. Staged roadmap target 70%+ (see `docs/Testing-Coverage-Strategy.md`, MED-01). |
