...
export const SYSTEM_PRESETS: Record<string, SystemConfig> = {
  'victron-3mp2-standard': {
    ...
    inverter: { model: 'Victron MultiPlus-II 48/5000/70-50', count: 3, ratedPowerW: 5000, mode: 'three-phase' },
    pv: { peakPowerKWp: 15.0, orientation: 'south', tiltDeg: 30, strings: 4, mpptCount: 2 },
    battery: { model: 'BYD Battery-Box Premium HVS 12.8', capacityKWh: 12.8, modules: 4, maxChargeRateKW: 12.8, maxDischargeRateKW: 12.8, minSoCPercent: 10, maxSoCPercent: 95, nominalVoltageV: 51.2, strategy: 'self-consumption' },
    evCharger: { model: 'Victron EV Charging Station', maxPowerKW: 22, phases: 3, ocppEnabled: true },
  ...
  'victron-3mp2-large': {
    ...
    inverter: { model: 'Victron MultiPlus-II 48/10000/140-100', count: 3, ratedPowerW: 10000, mode: 'three-phase' },
    pv: { peakPowerKWp: 30.0, orientation: 'east-west', tiltDeg: 15, strings: 8, mpptCount: 4 },
    battery: { model: 'BYD Battery-Box Premium HVS 25.6', capacityKWh: 25.6, modules: 8, maxChargeRateKW: 25.6, maxDischargeRateKW: 25.6, minSoCPercent: 10, maxSoCPercent: 95, nominalVoltageV: 51.2, strategy: 'self-consumption' },
    evCharger: { model: 'Victron EV Charging Station', maxPowerKW: 22, phases: 3, ocppEnabled: true },
  ...
  'victron-1mp2-compact': {
    ...
    inverter: { model: 'Victron MultiPlus-II 48/3000/35-32', count: 1, ratedPowerW: 3000, mode: 'single' },
    pv: { peakPowerKWp: 6.0, orientation: 'south', tiltDeg: 35, strings: 2, mpptCount: 1 },
    battery: { model: 'Pylontech US3000C', capacityKWh: 3.55, modules: 2, maxChargeRateKW: 3.55, maxDischargeRateKW: 3.55, minSoCPercent: 15, maxSoCPercent: 95, nominalVoltageV: 48, strategy: 'self-consumption' },
  ...
  custom: {
    ...
    battery: { model: '', capacityKWh: 10.0, modules: 1, maxChargeRateKW: 5.0, maxDischargeRateKW: 5.0, minSoCPercent: 10, maxSoCPercent: 100, nominalVoltageV: 51.2, strategy: 'self-consumption' },
