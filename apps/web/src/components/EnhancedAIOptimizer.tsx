...
/** Human-readable label for an AI provider id. Brand names stay untranslated;
 * only the on-device heuristic engine gets a descriptive, translated label. */
function useProviderLabel(provider: string | null): string | null {
  ...
  if (provider === 'heuristic') {
    return t('ai.providerHeuristic', 'On-device heuristic');
  }
