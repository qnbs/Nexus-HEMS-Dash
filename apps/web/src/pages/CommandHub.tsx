      ...
      <FloatingActionBar
        ...
        primaryAction={
          <button
            ...
            className="focus-ring inline-flex items-center gap-2 rounded-xl bg-(--color-primary) px-4 py-2 font-semibold text-sm text-(--color-on-primary) shadow-lg transition-colors hover:bg-(--color-primary)/80"
          >
